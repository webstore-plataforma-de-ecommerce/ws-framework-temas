...
ApiWS.ApiStart =  () => {
    try {
        ...
        var Token = document.querySelector("#HdTokenLojaTemp").value;
        ApiWS.LV = document.querySelector("#HD_LV_ID").value;
        ApiWS.LVdashview = "";
        var CliId = document.querySelector("#HD_LVCLI_ID").value;
        if (CliId != undefined && CliId != null && CliId != "" && CliId != "0") {
            WsParamAdds = "&WsCliId=" + CliId;
            console.log('entrou aqui' + WsParamAdds)
        }

        var CliIsB2b = document.querySelector("#LV_USU_B2B").value;
        CliIsB2b == "1" ? WsParamAdds += "&CliIsB2b=1" :  WsParamAdds += "&CliIsB2b=0"
        ...
        try {
            var layout = document.querySelector("#API_layout").value;
            if (layout) {
...
ApiWS.ListaProdutosHome =  FuncaoAfter => {
    ApiWS.StartTime();
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            let urlRequisicao = URLget + "?" + Parametros + cacheAdjust
            let config = {
                method: 'GET'
            };

                fetch(urlRequisicao, config)
                    .then((response)=>{
                        return response.text()
                    })
                    .then((data)=>{
                        console.log("ProdutosHome new");
                        data = ApiWS.LimpaJson(data);
                        var objverif = JSON.parse(data);
                        ...
                        if (!ApiWS.Json || objverif.erro > 0) {
                            ...
                            if (data.indexOf("erro") < 0) {
                                try {
                                    ApiWS.setCookie(NomeCookie, data, "M30");
                                } catch (e) { }
                            }
                            try { eval(FuncaoAfter + "()"); } catch (e) { }
...
ApiWS.ListaProdutosUltimos =  FuncaoAfter => {
    ApiWS.StartTime();
    if (FuncaoAfter != null && FuncaoAfter != "") {
        ...
        if (Ultimos != "" && Ultimos != null && Ultimos != undefined) {
            ...
            let config = {
                ...
                fetch(urlRequisicao, config)
                    ...
                    .catch((erro)=>{
                        console.log("Falha ListaProdutosUltimos " + erro.message + " - " + data);
...
ApiWS.ListaProdutosRelacionados =  FuncaoAfter => {
    ApiWS.StartTime();
    if (FuncaoAfter != null && FuncaoAfter != "") {
    ...
    try {
        ...
        var Token = document.querySelector("#HdTokenLojaTemp").value;
        var Produto = document.querySelector("#LV_HD_PROD_ID").value;
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            let config = {
                ...
                fetch(urlRequisicao, config)
                    ...
                    .catch((erro)=>{
                        console.log("Falha ListaProdutosRelacionados " + erro.message + " - " + data);
...
ApiWS.ListaProdutosDestaque =  FuncaoAfter => {
    ApiWS.StartTime();
    if (FuncaoAfter != null && FuncaoAfter != "") {
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            let urlChamada = URLget + "?" + Parametros + cacheAdjust
            let config = {
                method: 'GET'
            };
            ...
            fetch(urlChamada, config)
                ...
                .then(data => {
                    ...
                    try{    
                        ...
                        console.log("Falha ListaProdutosDestaque " + erro.message + " - " + data);
                ...
                .catch((erro)=>{
                    console.log(erro.message); console.log("Falha ao listar produtos em destaque");
                })
            // $.ajax({
            //     type: "GET",
            //     url: URLget,
...
ApiWS.ListaProdutosGrupos =  FuncaoAfter => {
    ApiWS.StartTime();
    if (FuncaoAfter != null && FuncaoAfter != "") {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            fetch(urlRequisicao, config)
                ...
                .then((data)=>{
                    console.log(data)
                    data = ApiWS.LimpaJson(data);
                    let objverif = JSON.parse(data)
                    ApiWS.Json = data;

                    console.log("ProdutosGrupos New");
                    if (data.indexOf("erro") < 0) {
                        try {
                            ApiWS.setCookie(NomeCookie, data, "H");
                        } catch (e) { }
                    }
                ...
                .catch((erro)=>{
                        console.log("Falha ListaProdutosGrupos " + erro.message + " - " + data);
                        ApiWS.DoAgain("ApiWS.ListaProdutosGrupos()", 2000, ApiWS.ListaProdutosGrupos_Tentativas);
                })
...
ApiWS.ProdutoDados = FuncaoAfter => {
    ApiWS.StartTime();
...
ApiWS.ListaCategorias = function (FuncaoAfter) {
    ...
    try {
        ...
        var Token = document.querySelector("#HdTokenLojaTemp").value;
        var VarsCategorias = document.querySelector("#VarsCategorias") == null ? null : document.querySelector("#VarsCategorias").value;

        var VarsFiltrosListagem = "";
        try { VarsFiltrosListagem = document.querySelector("#HdFiltrosListagem") == null ? null : document.querySelector("#HdFiltrosListagem").value; } catch (e) { }

        var VarsFiltrosListagemJson = "";
        try { VarsFiltrosListagemJson = document.querySelector("#HdFiltrosListagemJson") == null ? null : document.querySelector("#HdFiltrosListagemJson").value; } catch (e) { }

        var FieldsCategoriasId = "";
        var DptId = document.querySelector("#HD_CAT_ID") == null ? null : document.querySelector("#HD_CAT_ID").value;
        var DptTipo = document.querySelector("#HD_CAT_TIPO") == null ? null : document.querySelector("#HD_CAT_TIPO").value;
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            fetch(urlRequisicao, config)
                ...
                .catch((erro)=>{
                    console.log("Falha ListaCategorias " + erro.message + " - " + data);
                    ApiWS.DoAgain("ApiWS.ListaCategorias()", 2000, ApiWS.ListaCategorias_Tentativas);
                })
            // $.ajax({
            //     type: "GET",
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            fetch(urlRequisicao, config)
                ...
                .catch((erro)=>{
                    console.log("Falha ListaFiltros " + erro.message + " - " + retorno);
...
ApiWS.ListaProdutosPags = function (FuncaoAfter, PageNum) {
    ...
    var cacheAdjust = "&cachetype=" + ApiWS.cacheTime("M10");
    var VarsFiltrosListagem = "";
    try { VarsFiltrosListagem = document.querySelector("#HdFiltrosListagem").value; } catch (e) { }
    var VarsFiltrosListagemJson = "";
    try { VarsFiltrosListagemJson = document.querySelector("#HdFiltrosListagemJson").value; } catch (e) { }
    try {
        ApiWS.ListaProdutosPags_Tentativas++;
        var Token = document.querySelector("#HdTokenLojaTemp").value + pagina.replace("_", "");
        var InfoListagem = document.querySelector("#HdVarInfoListagem").value;
        var SubEtapaWs = document.querySelector("#HdSubEtapa").value;
        ...
        fetch(urlRequisicao, config)
            ...
            .catch((erro)=>{
                console.log("Falha ListaProdutosPags " + erro.message + " - " + retorno);
                ApiWS.DoAgain("ApiWS.ListaProdutosPags()", 2000, ApiWS.ListaProdutosPags_Tentativas);
            })
...
ApiWS.ListaFabricantes = function (FuncaoAfter) {
    ...
    try {
        ...
        var Token = document.querySelector("#HdTokenLojaTemp").value;
        var InfoListagem = document.querySelector("#HdVarInfoListagem") == null ? null : document.querySelector("#HdVarInfoListagem").value;
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            fetch(urlRequisicao, config)
                ...
                .then((data)=>{
                    ...
                    if (data.indexOf("erro") < 0) {
                        try {
                            ApiWS.setCookie(NomeCookie, data, "D");
                        } catch (e) { }
                    }
                    try { eval(FuncaoAfter + "()"); } catch (e) { }
                })
                .catch((erro)=>{
                    console.log("Falha ListaFabricantes " + erro.message + " - " + data);
...
ApiWS.ListaBanners = function (FuncaoAfter) {
    ...
    var BUSCA = "";
    try { BUSCA = document.querySelector("#LV_HD_BUSCA_VALOR") == null ? null : document.querySelector("#LV_HD_BUSCA_VALOR").value; } catch (e) { }
    if (BUSCA != undefined && BUSCA != "" && BUSCA != null) {
        ...
        try {
            ...
            var Token = document.querySelector("#HdTokenLojaTemp") == null ? null : document.querySelector("#HdTokenLojaTemp").value;
            var InfoListagem = document.querySelector("#HdVarInfoListagem") == null ? null: document.querySelector("#HdVarInfoListagem").value;
            ...
            if (Cookie != "" && Cookie != null && Cookie != undefined) {
                ...
                fetch(urlRequisicao, config)
                    ...
                    .catch((erro)=>{
                        console.log("Falha ListaBanners " + erro.message + " - " + data);
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            fetch(urlRequisicao, config)
                ...
                .catch((erro)=>{
                    console.log("Falha InfosLojas " + erro.message + " - " + data);
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            fetch(urlRequisicao, config)
                ...
                .catch((erro)=>{
                    ...
                    console.log("Falha PaginasAdd " + erro.message + " - " + retorno);
                })
...
ApiWS.Login = function (email, senha, FuncaoAfter) {
    ...
    try {
        var VAR_EMAIL = email;
        var VAR_SENHA = senha;
        var LV_ID = document.querySelector("#HD_LV_ID").value;
        ...
        let urlRequisicao = "/loginAJAX/login.aspx"

        let config = {
            method: "POST",
            body: "tipo=logar&LV_ID=" + LV_ID + "&LOGIN=" + VAR_EMAIL + "&SENHA=" + VAR_SENHA
        }
        function beforeSend() {
        ...
        fetch(urlRequisicao, config)
            ...
            .then((data)=>{
                ...
                else if (data.indexOf("AFTERLINK:") >= 0) {
                    ApiWS.resultLogin = ("Login efetuado com sucesso, aguarde.");
                    window.location.href = window.location.href;
                }
                else {
                    ApiWS.resultLogin = (data);
                }
                eval(FuncaoAfter + "()");
            ...
            .catch((error) => {
                ...
                ApiWS.resultLogin = ("Não foi possível efetuar o login, tente novamente.<!--" + error.responseText + "-->");
                eval(FuncaoAfter + "()");
            })
...
ApiWS.CadastraNews = function (Nome, Email, FuncaoAfter) {
    try {
        ...
        let urlRequisicao = UrlApi + "/" + VersaoApi + "/cadastra-news"

        let config = {
            method: "POST",
            body: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + WsParamAdds + "&Nome=" + Nome + "&Email=" + Email
        }
        fetch(urlRequisicao,)
            .then(response => {
                return response.text()
            ...
            .catch((erro) => {
                console.log("Erro ao cadastrar email de newsletter." + erro.message);
            })
        // $.ajax({
        //     type: "POST",
    ...
    try {
        ...
        if (URL.indexOf("logoff") < 0) {
            ...
            if (URL.length > 10) {
                ...
                let urlRequisicao = UrlApi + "/" + VersaoApi + "/InfosLojas"
                ...
                fetch(urlRequisicao, config)
                    ...
                    .catch((erro)=>{
                        console.log("Falha analisando 301");
                    })
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            fetch(urlRequisicao, config)
                ...
                .catch((erro)=>{
                    console.log("Erro ao tentar importar arquivo." + erro.message);
                })
...
ApiWS.nameCookie = function (name, value, tipo) {
    ...
    var B2B = document.querySelector("#LV_USU_B2B").value;
    var URL = window.location.href;
...
function funcaoWsTokenStart() {
    ...
    try {
        ...
        var ObjWsExist = document.querySelector("#" + ObjAtualWsToken).innerHTML;

        document.querySelector("a[rel='Webstore']").parentNode.parentNode.parentNode.remove();

        if (ObjWsExist) {
            document.querySelector("#" + ObjAtualWsToken).remove();
            document.querySelector("style[rel='wstokencss" + ObjAtualWsToken+"']").remove();
        }
        ...
        if (typeof wsx015694030 == 'undefined') {
            document.querySelector("body").append(print);
        }
