...
ApiWS.ListaProdutosHome = function (FuncaoAfter) {
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            var Parametros = "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token;
...
ApiWS.ListaProdutosUltimos = function (FuncaoAfter) {
    ...
    try {
        ...
        if (Ultimos != "" && Ultimos != null && Ultimos != undefined) {
            ...
            $.ajax({
                type: "GET",
                url: UrlApi +  "/"+ VersaoApi + "/produtos/ultimos",
                data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + "&ultimos=" + Ultimos,
                beforeSend: function () { },
...
ApiWS.ListaProdutosRelacionados = function (FuncaoAfter) {
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            $.ajax({
                type: "GET",
                url: UrlApi +  "/"+ VersaoApi + "/produtos/relacionados",
                data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + "&Produto=" + Produto,
                beforeSend: function () { },
                error: function (e) { console.log(e.message); console.log("Falha ao listar produtos vistos recentemente"); },
                success: function (retorno) {
...
ApiWS.ListaProdutosDestaque = function (FuncaoAfter) {
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            $.ajax({
                type: "GET",
                url: UrlApi +  "/"+ VersaoApi + "/produtos/destaques",
                data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token,
                beforeSend: function () { },
...
ApiWS.ProdutoDados = function (FuncaoAfter) {
    ...
    try {
        ...
        $.ajax({
            type: "GET",
            url: UrlApi +  "/"+ VersaoApi + "/produtos/dadosproduto",
            data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + "&Produto=" + Produto,
            beforeSend: function () { },
            error: function (e) { console.log(e.message); console.log("Falha ao listar grupos da página inicial"); },
            success: function (retorno) {
...
ApiWS.ListaCategorias = function (FuncaoAfter) {
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            $.ajax({
                type: "GET",
                url: UrlApi +  "/"+ VersaoApi + "/categorias",
                data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + "&VarsCategorias=" + VarsCategorias,
                beforeSend: function () { },
...
ApiWS.ListaProdutosPags = function (FuncaoAfter) {
    ...
    try {
        ...
        $.ajax({
            type: "GET",
            url: UrlApi +  "/"+ VersaoApi + "/produtos/listagem",
            data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + "&InfoListagem=" + InfoListagem,
            beforeSend: function () { },
...
ApiWS.ListaFabricantes = function (FuncaoAfter) {
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            $.ajax({
                type: "GET",
                url: UrlApi +  "/"+ VersaoApi + "/fabricantes",
                data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token,
                beforeSend: function () { },
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            $.ajax({
                ...
                beforeSend: function () {  },
                error: function (e) {
                    console.log("Erro ao verificar informações da loja.(" + "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + " / " + e.message + ")");
                ...
                success: function (retorno) {
                    ...
                    try {
                        ...
                        ApiWS.Json = retorno;
                        //console.log("InfosLojas:" + ApiWS.Json + " (" + "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + ")");
...
ApiWS.CadastraNews = function (Nome, Email, FuncaoAfter) {
    ...
    try {
        ...
        $.ajax({
            ...
            data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + "&Nome=" + Nome + "&Email=" + Email,
            beforeSend: function () { },
...
ApiWS.ImportFile = function (file, FuncaoAfter) {
    ...
    try {
        ...
        if (Cookie != "" && Cookie != null && Cookie != undefined) {
            ...
            $.ajax({
                type: "GET",
                url: UrlApi +  "/"+ VersaoApi + "/importfile",
                data: "LOJA=" + ApiWS.LV + "&LVdashview=" + ApiWS.LVdashview + "&LvToken=" + Token + "&File=" + file,
                beforeSend: function () { },
